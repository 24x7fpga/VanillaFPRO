...
## External Reset 
## Push button 3 is used as the reset button
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { reset_n }]; #IO_L7P_T1_34 Sch=btn[3]
...
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { rx }]; #IO_L19P_T3_35 Sch=je[4]                     
